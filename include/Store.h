...
class Store : public Entity
{
    private:
        ...
        Vector2f     m_stdTowerShopPos = { 0.f, 0.f };
        Vector2f     m_expTowerShopPos = { 0.f, 0.f };
        Vector2f     m_slwTowerShopPos = { 0.f, 0.f };
    ...
    public:
        ...
        */
        ...
        Vector2f         getStandardTowerPos() const;
        Vector2f         getSlowingTowerPos() const;
        Vector2f         getExplosiveTowerPos() const;
